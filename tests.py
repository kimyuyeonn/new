...
# 기준 학번을 제외한 나머지 학번에 대해 케빈 베이컨 수 계산
for student in students:
    if student != start_node:
        path_length = nx.shortest_path_length(G, start_node, student)
        kevin_bacon_numbers[student] = path_length

# 입력된 학번을 기준으로 다른 학생들의 케빈 베이컨 수 출력
print(f"{start_node} 학번을 기준으로 다른 학생들의 케빈 베이컨 수:")
for student in students:
    if student != start_node:
        print(f"{student}: {kevin_bacon_numbers[student]}")
